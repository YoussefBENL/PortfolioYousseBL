...
if (navToggleBtn) {
    const navDropdown = document.getElementById('nav-dropdown-links');
    ...
    navToggleBtn.addEventListener('click', () => {
        ...
        if (navIcon) {
            navIcon.classList.toggle('fa-ellipsis', !isOpen);
    ...
    if (navDropdown) {
        navDropdown.querySelectorAll('a').forEach((link) => {
            link.addEventListener('click', () => {
                ...
                const navIcon = navToggleBtn.querySelector('i');
                if (navIcon) {
                    navIcon.classList.add('fa-ellipsis');
        ...
        document.addEventListener('click', (event) => {
            ...
            const clickedInsideMenu = navDropdown.contains(event.target);
...
const sections = ['presentation', 'outils', 'competences', 'all-projects', 'contact-form'];
...
document.getElementById('scroll-down-arrow').addEventListener('click', () => {
    ...
    if (nextSection) window.scrollTo({ top: nextSection.offsetTop, behavior: 'smooth' });
});
